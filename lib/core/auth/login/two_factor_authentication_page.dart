...
final Map<TwoFaProviderType, TwoFactorAuthProviderLoginData>
  ...
  TwoFaProviderType.TOTP: TwoFactorAuthProviderLoginData(
      nameFunction: (context) => 'mfaProviderTopt'.tr,
      descFunction: (context, contact) => 'totpAuthDescription'.tr,
      placeholderFunction: (context) => 'toptAuthPlaceholder'.tr,
      icon: 'cellphone-key'),
  TwoFaProviderType.SMS: TwoFactorAuthProviderLoginData(
      nameFunction: (context) =>'mfaProviderSms'.tr,
      descFunction: (context, contact) =>
         'smsAuthDescription'.tr,
      placeholderFunction: (context) =>'smsAuthPlaceholder'.tr,
      icon: 'message-reply-text-outline'),
  TwoFaProviderType.EMAIL: TwoFactorAuthProviderLoginData(
      nameFunction: (context) =>  'mfaProviderEmail'.tr,
      descFunction: (context, contact) =>
           'emailAuthDescription'.tr,
      placeholderFunction: (context) =>  "emailAuthPlaceholder".tr,
      icon: 'email-outline'),
  TwoFaProviderType.BACKUP_CODE: TwoFactorAuthProviderLoginData(
      nameFunction: (context) =>  'mfaProviderBackupCode'.tr,
      descFunction: (context, contact) =>
           'backupCodeAuthDescription'.tr,
      placeholderFunction: (context) =>  'backupCodeAuthPlaceholder'.tr,
      icon: 'lock-outline')
};
            ...
            body: Stack(children: [
              ...
              SizedBox.expand(
                child: Scaffold(
                  ...
                  appBar: TbAppBar(
                    tbContext,
                    title: Text('verifyYourIdentity'.tr),
                  ),
                  body: Stack(children: [
                    SizedBox.expand(
                        child: Padding(
                                                                          ...
                                                                          builder: (context,
                                                                            ...
                                                                            if (countDown >
                                                                              ...
                                                                              return Padding(
                                                                                ...
                                                                                child: Text(
                                                                                 '${ "resendCodeWait".tr}'+countDown.toString(),
  ...
  FormBuilderTextField _buildVerificationCodeField(
    ...
    List<FormFieldValidator<String>> validators = [
      FormBuilderValidators.required(
          errorText: 'verificationCodeInvalid'.tr),
        ...
        if (e is ThingsboardError) {
          if (e.status == 400) {
            _twoFactorAuthFormKey.currentState!.fields['verificationCode']!
                .invalidate('verificationCodeIncorrect'.tr);
          } else if (e.status == 429) {
            _twoFactorAuthFormKey.currentState!.fields['verificationCode']!
                .invalidate('verificationCodeManyRequest'.tr);
