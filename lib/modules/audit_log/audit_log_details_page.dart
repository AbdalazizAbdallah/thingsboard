...
import 'package:things_board_app/modules/audit_log/audit_logs_base.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
            ...
            children: [
              Text('entityType'.tr, style: labelTextStyle),
              ...
              Flexible(
                  fit: FlexFit.loose,
                  child: buildBorderedText('actionData'.tr,
              ...
              if (widget.auditLog.actionStatus == ActionStatus.FAILURE)
                Flexible(
                    fit: FlexFit.loose,
                    child: buildBorderedText('failureDetails'.tr,
