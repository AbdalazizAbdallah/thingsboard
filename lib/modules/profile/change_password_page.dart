  ...
  Future<void> _changePassword() async {
    ...
    if (_changePasswordFormKey.currentState?.saveAndValidate() ?? false) {
      ...
      if (newPassword != newPassword2) {
        showErrorNotification('passwordErrorNotification'.tr);
      } else {
