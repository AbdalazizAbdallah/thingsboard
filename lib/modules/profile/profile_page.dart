...
import 'package:things_board_app/modules/profile/change_password_page.dart';
...
class _ProfilePageState extends TbPageState<ProfilePage> {
  ...
  Future<void> _saveProfile() async {
    if (_currentUser != null) {
      ...
      if (_profileFormKey.currentState?.saveAndValidate() ?? false) {
        ...
        _isLoadingNotifier.value = false;
        showSuccessNotification('profileSuccessNotification'.tr,
  ...
  _changePassword() async {
    ...
    if (res == true) {
      showSuccessNotification('passwordSuccessNotification'.tr,
          duration: Duration(milliseconds: 1500));
    }
  }
}
