...
import 'package:things_board_app/constants/app_constants.dart';
import 'package:things_board_app/constants/assets_path.dart';
...
import 'package:things_board_app/modules/dashboard/web_view_linux.dart';
import 'package:things_board_app/utils/utils.dart';
...
mixin DashboardsBase on EntitiesBase<DashboardInfo, PageLink> {
  ...
  void onEntityTap(DashboardInfo dashboard) {
    if (Platform.isLinux) {
      HiveController().setWebViewLinux('yes');
      print("developer getWebViewLinux : ${HiveController().getWebViewLinux} ");
      print("developer dashboard.id!.id! : ${dashboard.id!.id!} ");
      print("developer dashboard.title : ${dashboard.title}  ");
      ///  _launchUrl(Uri.parse(ThingsboardAppConstants.thingsBoardApiEndpoint + '/dashboard/' + dashboard.id!.id!));
      webViewLinux(ThingsboardAppConstants.thingsBoardApiEndpoint + '/dashboard/' + dashboard.id!.id!);
    } else {
