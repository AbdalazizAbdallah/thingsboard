...
import 'package:things_board_app/modules/alarm/alarms_page.dart';
import 'package:things_board_app/modules/device/devices_main_page.dart';
import 'package:things_board_app/modules/home/home_page.dart';
import 'package:things_board_app/modules/more/more_page.dart';
    ...
    for (var item in items) {
      switch (item.path) {
        case '/home':
          ...
          break;
        case '/alarms':
          item.title = 'alarms'.tr;
          break;
        case '/devices':
          item.title = 'devices'.tr;
          break;
        case '/more':
          item.title = 'more'.tr;
          break;
