...
import 'package:things_board_app/utils/transition/page_transitions.dart';

import '../../utils/services/local_storage.dart';

Color _tbPrimaryColor =  Color(HiveController().getColor);
Color _tbSecondaryColor =   Color(HiveController().getColor).withOpacity(.7);
Color _tbDarkPrimaryColor =   Color(HiveController().getColor).withOpacity(.4);

const int _tbTextColorValue = 0xFF282828;
Color _tbTextColor = Color(_tbTextColorValue);

var tbTypography = Typography.material2018();

var  tbMatIndigo = MaterialColor(
...
var  tbDarkMatIndigo = MaterialColor(
  HiveController().getColor ,
  <int, Color>{
    50: Color(0xFFE8EAF6),
    100: Color(0xFFC5CAE9),
